...
module.exports = {
    //Mau Chung 1
    button_1_vi: new make('web_url',user.Link_DieuKien,'Xem Chiến Dịch','full',"false"), //
    button_1: new make('web_url',user.Link_DieuKien,'View Campaign','full',"false"),//
    ...
    button_7_vi: new make("web_url",user.Link_Vi,"Xem Tài Khoản","full","false"),//
    button_7: new make("web_url",user.Link_Vi,"My Account","full","false"),//
    //Mau chung chia se
