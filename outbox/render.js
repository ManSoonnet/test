...
//*************************Menu***********************************
//Menu Tang 2
const menu_1_1_vi =  new make("web_url",user.Link_DieuKien,"Điều Kiện","full","true");
const menu_1_1 =  new make("web_url",user.Link_DieuKien,"Condition","full","true");
...
module.exports = {
    ...
    menu_1_1_vi : new make("web_url",user.Link_DieuKien,"Điều Kiện","full","true"),
    menu_1_1 : new make("web_url",user.Link_DieuKien,"Condition","full","true")
}